...
import DotThucTapNV from '@containers/DTTComponents/nhiemVu-DotTT'
...
function NhiemVu_DotThucTap({isLoading, myInfo, ...props}) {
  ...
  return (
    <>
      <Loading active={isLoading}>
        ...
        {isGiangVien &&  infoGiangVien && <DotThucTapNV maGiangVien={infoGiangVien._id}/>}
      </Loading>
    </>
  )
}
...
export default (connect(mapStateToProps, actions)(NhiemVu_DotThucTap));
