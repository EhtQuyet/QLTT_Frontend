...
function KiemDuyetNhatKy({ isLoading, myInfo, ...props }) {
  ...
  const columns = [
    ...
    },
    {
      align: 'center',
      render: (value) =>
        <Link to={URL.MENU.NHAT_KY_ITEM_ID.format(value.sinhVien?._id)}>
...
export default (connect(mapStateToProps, actions)(KiemDuyetNhatKy));
